/**
 * Tailwind default palette recognition.
 *
 * Colors that exactly match the Tailwind v3 default palette are emitted as
 * their standard class (`bg-slate-900`, `text-indigo-500`, …) instead of an
 * arbitrary value (`bg-[#0f172a]`) — they are the design-system baseline and
 * need no theme extension. Non-palette colors fall through to generated
 * design tokens (see tokens.ts).
 */

import { parseColor, toHex } from '@framer/compiler-shared';

/** The Tailwind v3 default color palette, keyed by lowercase hex without '#'. */
export const TAILWIND_PALETTE: Record<string, string> = {
    ...
    // neutral
    'f5f5f5': 'neutral-100', 'e5e5e5': 'neutral-200', 'd4d4d4': 'neutral-300', 'a3a3a3': 'neutral-400',
    '737373': 'neutral-500', '525252': 'neutral-600', '404040': 'neutral-700', '262626': 'neutral-800',
    '171717': 'neutral-900', '0a0a0a': 'neutral-950',
    // stone
    'fafaf9': 'stone-50', 'f5f5f4': 'stone-100', 'e7e5e4': 'stone-200', 'd6d3d1': 'stone-300',
    'a8a29e': 'stone-400', '78716c': 'stone-500', '57534e': 'stone-600', '44403c': 'stone-700',
    '292524': 'stone-800', '1c1917': 'stone-900', '0c0a09': 'stone-950',
    // red
    ...
    '9a3412': 'orange-800', '7c2d12': 'orange-900', '431407': 'orange-950',
    // amber
    ...
    '3f6212': 'lime-800', '365314': 'lime-900', '1a2e05': 'lime-950',
    // green
    ...
    '065f46': 'emerald-800', '064e3b': 'emerald-900', '022c22': 'emerald-950',
    // teal
    ...
    '115e59': 'teal-800', '134e4a': 'teal-900', '042f2e': 'teal-950',
    // cyan
    ...
    '3730a3': 'indigo-800', '312e81': 'indigo-900', '1e1b4b': 'indigo-950',
    // violet
    ...
    '5b21b6': 'violet-800', '4c1d95': 'violet-900', '2e1065': 'violet-950',
    // purple
    ...
    '6b21a8': 'purple-800', '581c87': 'purple-900', '3b0764': 'purple-950',
    // fuchsia
    ...
    '86198f': 'fuchsia-800', '701a75': 'fuchsia-900', '4a044e': 'fuchsia-950',
    // pink
    ...
    '9d174d': 'pink-800', '831843': 'pink-900', '500724': 'pink-950',
    // rose
    ...
    '9f1239': 'rose-800', '881337': 'rose-900', '4c0519': 'rose-950',
    // base
    'ffffff': 'white', '000000': 'black',
};

/**
 * Match an opaque color against the Tailwind default palette.
 * Returns the palette class name (e.g. 'slate-900') or undefined.
 */
export function matchPalette(color: string): string | undefined {
    const parsed = parseColor(color);
    if (!parsed || parsed.a < 1) return undefined;
    return TAILWIND_PALETTE[toHex(parsed).slice(1)];
}
